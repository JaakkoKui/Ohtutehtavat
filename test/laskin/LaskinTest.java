...
public class LaskinTest { // Luokan nimen loppu pitää olla Test
    ...
    public void testJaaNollalla() {
        Exception poikkeus = assertThrows(IllegalArgumentException.class, () -> laskin.jaa(0));
        assertEquals("Nollalla ei voi jakaa", poikkeus.getMessage());
    }
 
    @Test
    @DisplayName("HUOMAA - Metodi kerro() on vielä toteuttamatta, eikä sitä haluta ajaa vielä")
